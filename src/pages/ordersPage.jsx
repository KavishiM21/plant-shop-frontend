            ...
            <table className="w-full text-center border-collapse">
              <thead className="sticky top-0">
                <tr className="bg-secondary text-primary h-[60px] text-sm tracking-wide uppercase">
                  <th className="px-5 sticky top-0 bg-secondary z-10">
                    Order ID
                  </th>
                  <th className="px-7 sticky top-0 bg-secondary z-10">
                    Customer Email
                  </th>
                  <th className="px-5 sticky top-0 bg-secondary z-10">
                    Customer Name
                  </th>
                  <th className="px-5 sticky top-0 bg-secondary z-10">Date</th>
                  <th className="px-5 sticky top-0 bg-secondary z-10">
                    Status
                  </th>
                  <th className="px-5 sticky top-0 bg-secondary z-10">
